  ...
  try {
    ...
    res.status(200).send(`
      <div style="font-family: sans-serif; text-align: center; padding: 50px; background: #0c0c0e; color: #fff; min-height: 100vh;">
        ...
        <p style="margin-top: 30px;"><a href="http://localhost:3000/login" style="background: #ff4500; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold;">Go to Login Page</a></p>
      </div>
    `);
  } catch (error) {
